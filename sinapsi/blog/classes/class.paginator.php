...
class Paginator{
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$prev"."$ext'>Newest</a></li>";
		else
		    $pagination.= "<li><span class='disabled'>Newest</span></li>";   
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext'>Older</a></li>";
		else
		    $pagination.= "<li><span class='disabled'>Older</span></li>";
		    $pagination.= "</ul>\n";       
		}
